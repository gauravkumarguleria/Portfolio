    ...
    >
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left mt-10 md:mt-0">
          {/* Greeting */}
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-purple-800 mb-3 leading-tight drop-shadow-[2px_2px_0px_#000]">
            👋 Hi, I am
          </h1>
          {/* Name */}
          <h2 className="text-5xl sm:text-6xl md:text-7xl font-extrabold text-pink-600 mb-6 leading-tight drop-shadow-[2px_2px_0px_#000]">
            Gaurav Kumar Guleria
          </h2>
          {/* Skills Heading with Typing Effect */}
          <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 text-purple-700 leading-tight bg-yellow-200 px-4 py-2 rounded-xl border-4 border-black  inline-block">
